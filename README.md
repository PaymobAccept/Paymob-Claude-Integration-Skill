...
```bash
claude plugin install --git https://github.com/MRagabMob/Paymob-Claude-Integration-Plugin-Skill
```
...
```bash
git clone https://github.com/MRagabMob/Paymob-Claude-Integration-Plugin-Skill.git
